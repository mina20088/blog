                ...
                <tr class="bg-white border-b text-nowrap border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-center gap-2">
                            <a href="<?php echo e(route('dashboard.users.show', ['user' => $user])); ?>"><i class="fa-regular fa-eye fa-xl hover:text-blue-500 py-[0.1rem]"></i></a>
...
<?php endif; ?>
<?php /**PATH C:\Users\minar\projects\blog\resources\views/components/users/user-table.blade.php ENDPATH**/ ?>