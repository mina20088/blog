...
<section class="flex xs:flex-col xs:gap-3 md:flex-row justify-between md:items-center xs:my-3 md:my-9">
    <div class='flex xs:basis-full xs:order-2 md:order-1'>
        <?php if($paginator->hasPages()): ?>
            <nav class="basis-full">
                <ul
                    class="flex md:items-center xs:items-start -space-x-px h-8 text-sm xs:justify-between md:justify-normal w-full">
    ...
    <div
        class='flex xs:flex-col md:flex-row  md:items-center xs:basis-full xl:basis-full md:justify-between xl:justify-end xs:gap-4 xs:order-1 '>
