...
<main class="flex">
    <aside id="logo-sidebar" class="xs:fixed  top-0 left-0 lg:sticky xs:w-full md:w-4/12 lg:w-3/12 xl:w-72 xs:z-40  lg:z-0 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 lg:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    ...
    <section class="p-4 lg:w-9/12 xl:w-full">
        @yield('content')
    </section>
</main>
