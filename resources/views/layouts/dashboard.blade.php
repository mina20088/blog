...
<main class="flex">
    <aside id="logo-sidebar" class="xs:fixed  top-0 left-0 xl:sticky xs:w-full md:w-6/12 lg:w-4/12  xl:w-[30rem] xs:z-40  xl:z-0 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 xl:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
