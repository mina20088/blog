...
<x-card>
    ...
    <section class="grid xs:grid-cols-1 md:grid-cols-2 md:gap-3">
        <section>
            ...
            <x-input type="text" name="x" id="x" placeholder="X" :value="old('x')"/>
            <x-single-error field-name="x"/>
        </section>

        <section>
            <x-label for="website" content="Website"/>
            <x-input type="text" name="website" id="website" placeholder="website" :value="old('website')"/>
    ...
    <section class="grid xs:grid-cols-1 md:grid-cols-2 md:gap-3">
        <section>
            ...
            <x-input type="instagram" name="instagram" id="instagram" placeholder="instagram" :value="old('instagram')"/>
            <x-single-error field-name="instagram"/>
        </section>

        <section>
            <x-label for="facebook" content="Facebook"/>
            <x-input type="text" name="facebook" id="facebook" placeholder="facebook" :value="old('facebook')"/>
