                    ...
                    >
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="first_name"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">first
                                name:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="last_name"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">last
                                name:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="email"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">email:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="username"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">username:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="password"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">password:</label>
                    ...
                    >
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="date_of_birth"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">birth-date:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="date_of_birth"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">gender:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="phone_number"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg ">phone:</label>
                        ...
                        <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                            <label for="countries"
                                   class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg">country:</label>
                            <select id="countries"
                        ...
                        <template x-if="country != '' && country != -1">
                            <div class="flex xs:flex-col md:flex-row md:items-center gap-1">
                                <label for="city"
                                       class="block text-sm font-medium text-gray-900 dark:text-white md:basis-28 xs:font-bold xs:text-lg">city:</label>
                                <select id="city"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
